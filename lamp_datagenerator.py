...
def main():
    ...
    plt.subplot(3, 1, 3)
    plt.plot(sigma_, label='sigma', color='orange', linewidth=1)
    plt.xlabel('time')
    plt.legend()
    ...
    np.savetxt(fname='data/lamp_sigma.txt',fmt='%.5f', X=sigma_, delimiter=',')
    print('data saved')
